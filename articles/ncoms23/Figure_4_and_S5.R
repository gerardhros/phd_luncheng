...
# derive the meta-analytical model
    ...
    # read data  
    d1 <- readxl::read_xlsx('C:/Users/86188/Desktop/Source Data.xlsx',sheet = "Figure4andS5")
    d1 <- as.data.table(d1)
...
###############################################################################################################################
    ...
    ggsave(p, file = "C:/Users/86188/Desktop/Figures/Figure_4.png",width = 410,height = 197, units = "mm")
